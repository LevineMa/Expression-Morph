                ...
                try:
                    if word[0] == "(":      #If the first letter is a "(" use the try except to see if the next value is an integer
                        try:
                            ...
                            if lineSplit[0] == "disgust" and lineSplit[1] == "surprise" and lineSplit[2] == "male":     #Same as anger fear
...
def itemAnalysisMapMaker(filename):                     #Initializes and then populates the item analysis dictionary
    ...
    for line in file:                                   #Loops through all the lines in the file and splits them at every comma
        ...
        try:
            ...
            splitLine = splitLine
        for value in itemAnalysis:                          #Finishes initializing the item analysis dictionary which is a map from the stimuli name to a map of each percentage in the continuua to another map of e and i to how many times they occur
